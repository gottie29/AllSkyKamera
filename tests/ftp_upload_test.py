...
def test_ftp_connection():
    try:
        ...
        listing = ftp.nlst()
        print(f"ℹ️ Aktueller Verzeichnisinhalt: {listing}")
        ftp.quit()
...
def test_image_upload():
    ...
    print(f"ℹ️ Testdatei erstellt: {test_file}")
    ...
    try:
        ...
        print(f"ℹ️ Testdatei remote gelöscht: {os.path.basename(test_file)}")
        ftp.quit()
    except Exception as e:
        print(f"⚠️ Konnte Testdatei remote nicht löschen: {e}")
