...
from askutils.uploader.manual_upload_api import upload_manual_batch
...
def main() -> None:
    if len(sys.argv) != 2 or sys.argv[1] in ("-h", "--help"):
        print(
            ...
            "    -> laedt keogram / startrail / video fuer diesen Tag per HTTPS hoch\n",
            flush=True,
        )
        if len(sys.argv) != 2:
            sys.exit(1)
    ...
    print(f"Starte MANUELLEN HTTPS-Upload fuer Datum {date_str} ...", flush=True)
